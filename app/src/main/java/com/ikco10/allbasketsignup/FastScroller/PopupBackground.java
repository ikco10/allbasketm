...
class PopupBackground extends Drawable {
    ...
    PopupBackground(@NonNull Context context) {
        mPaint = new Paint();
        mPaint.setAntiAlias(true);
        mPaint.setColor(Utils.getColorFromAttrRes(R.attr.colorControlActivated, context));
        mPaint.setStyle(Paint.Style.FILL);
        Resources resources = context.getResources();
        mPaddingStart = resources.getDimensionPixelOffset(R.dimen.fastscroller_popup_padding_start);
        mPaddingEnd = resources.getDimensionPixelOffset(R.dimen.fastscroller_popup_padding_end);
    }
