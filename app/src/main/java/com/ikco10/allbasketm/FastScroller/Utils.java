...
class Utils {
    ...
    @ColorInt
    static int getColorFromAttrRes(@AttrRes int attrRes, @NonNull Context context) {
    ...
    @Nullable
    private static ColorStateList getColorStateListFromAttrRes(@AttrRes int attrRes,
